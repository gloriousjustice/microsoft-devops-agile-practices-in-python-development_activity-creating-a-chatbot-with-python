...
def extract_symptoms(user_input):
    ...
    for token in doc:
        ...
        if token_text in medical_data["symptoms"] and token_text not in extracted_symptoms:
    ...
    if extracted_symptoms:
        ...
        if possible_conditions:
            ...
            for condition, count in sorted_conditions:
                recommendation = medical_data["recommendations"].get(condition, "No recommendation available.")
